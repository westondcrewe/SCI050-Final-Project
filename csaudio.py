...
def tr(params, rf):
    ...
    samps = [x for x in rf]    # covert to numeric bytes
...
def read_wav(filename, sound_data):
    ...
    print('   ', len(rf), 'length of rf')
    print('   ', [x for x in rf[0:3]], 'first 3 frames of rf')
    print('   ', numchannels, 'audio channels, taken at')
    print('   ', datawidth, 'as datawidth (bytes per sample)')
